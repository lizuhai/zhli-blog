...
<html lang="en">
  ...
  <body>
    ...
    <div class="post-comment" style="margin-top:102px;margin-left: 70px;margin-right: 70px">
	    <h3><strong>修改博客</strong></h3>
	    	<form class="form-horizontal" role="form" action="BlogAction_saveEditedBlog" method="post">
	    	 <s:set value="editedBlog.id" var="id"/>
    		 <s:hidden name="editedBlog.id" value="%{#id}"></s:hidden>
	         <div class="form-group">
	             <div class="col-lg-6">
	                  	<h5>博文标题：</h5><input type="text" value='<s:property value="editedBlog.title"/>' name="editedBlog.title" placeholder="标题" class="col-lg-12 form-control">
	              </div>
	              <div class="col-lg-6">
	                  	<h5>博文所属目录：</h5><input type="text" value='<s:property value="editedBlog.category"/>' name="editedBlog.category" class="col-lg-12 form-control">
	              </div>
	         </div>
	         <div class="form-group">
	             <div class="col-lg-12">
	                 <textarea name="editedBlog.content"  rows="11" class=" form-control"><s:property value="editedBlog.content"/></textarea>
	             </div>
	         </div>
	         <div class="form-group">
	             <div class="col-lg-12">
	                  <h5>博文所标签：</h5><input type="text" value='<s:property value="editedBlog.tag"/>' name="editedBlog.tag" class="col-lg-12 form-control">
	                  <br>
                  	   推荐标签：
	         ...
	         <p>
	             <button type="submit" class="btn btn-danger pull-right">确认</button>
	         </p>
	     </form>
